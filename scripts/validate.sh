...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    declare -a plugins=("build/NeuralSIMDRuntimePlugin_artefacts/VST3/NeuralSIMDRuntimePlugin.vst3")
else
    pluginval=$(install_pluginval_win)
    declare -a plugins=("build/NeuralSIMDRuntimePlugin_artefacts/Release/VST3/NeuralSIMDRuntimePlugin.vst3")
fi
