...
mkdir -p bin/Win64
mkdir -p bin/Win32
declare -a plugins=("NeuralSIMDRuntimePlugin")
...
(
    cd bin
    rm -f "NeuralSIMDRuntimePlugin-Win64-${VERSION}.zip"
    zip -r "NeuralSIMDRuntimePlugin-Win64-${VERSION}.zip" Win64
    # rm -f "NeuralSIMDRuntimePlugin-Win32-${VERSION}.zip"
    # zip -r "NeuralSIMDRuntimePlugin-Win32-${VERSION}.zip" Win32
)
